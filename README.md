...
- из текста не очень понятно где именно будут располагатьстся файлы пользователей - в тарантуле или в какой то другой системе, просьба расписать этот момент подробнее. 
- каким образом сервисы auth/documents/payments будут общаться друг с другом , какие технологии для этого будут использоваться? 
- какой сервис будет отвечать за role based access control для управления правами на доступ к документам?